...
const TeacherLayout = () => {
  ...
  const notifications = [
    {
      id: 1,
      message: "New assignment submission from Aarav Kumar",
      time: "5 min ago",
      unread: true,
    },
    {
    ...
    {
      id: 3,
      message: "Grade 10-A attendance marked successfully",
      time: "2 hours ago",
      unread: false,
    },
    {
  ...
  const menuItems = [
...

    {
      title: "Lesson Plans",
      icon: FileText,
      path: "/teacher/curriculum/lessons",
      badge: null,
    },
    ...
    },
    {
      ...
      icon: PieChart,
      path: "/teacher/classes/analytics",
      badge: null,
    },
    {
      title: "My Classes",
                    ...
                    <div className="p-4 border-b border-gray-200 bg-gradient-to-br from-indigo-50 to-purple-50">
                      ...
                      {(user?.department || user?.employeeId) && (
                        <p className="text-xs text-gray-500 mt-2">
                          {[
                            user?.department,
                            user?.employeeId ? `ID: ${user.employeeId}` : null,
                          ]
                            .filter(Boolean)
                            .join(" · ")}
                        </p>
      ...
      <footer className="lg:ml-64 bg-white border-t border-gray-200 py-4 px-6">
        <div className="flex flex-wrap justify-between items-center gap-4 text-sm text-gray-600">
          ...
          <div className="flex gap-4">
            <Link to="/teacher/help" className="hover:text-indigo-600">
              Help
            </Link>
