...
const NAV = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: BarChart3,
        path: "/school-admin/results/analytics",
        badge: "New",
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Calendar,
        path: "/school-admin/curriculum/calendar",
      },
      {
        name: "Certificates",
        icon: FileText,
...
export default function SchoolAdminLayout() {
  ...
  const schoolName = user?.schoolId?.name || "School";
      ...
      <aside className={`sal-sidebar ${sideOpen ? "" : "closed"}`}>
        ...
        <div className="sal-sidebar-user">
          ...
          <div className="sal-sidebar-user-info">
            <div
              className="sal-sidebar-user-name"
              style={{
                fontSize: 13,
                fontWeight: 600,
                color: "#fff",
